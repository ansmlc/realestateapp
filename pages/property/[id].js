...
const PropertyDetails = ({ propertyDetails: { price, rentFrequency, rooms, title, baths, agency, isVerified, description, area, type, purpose, furnushingStatus, amenities, photos } }) => (
